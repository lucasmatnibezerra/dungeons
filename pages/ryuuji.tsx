...
import RyuujiHistory from "../components/characters/ryuujiHistory";
import { ScrollContext } from "../utils/scroll-observer";

const Ryuuji: React.FC = () => {
  return (
    <div className=" bg-[#0A0A0C]">
      <div className="bg-top bg-cover relative min-h-[88vh]">
        <div className="min-h-[500px]">
          <div className="absolute right-0 left-0 bottom-0 bg-local bg-no-repeat bg-[#0a0a0c] bg-cover w-full bg-ryuuji ">
